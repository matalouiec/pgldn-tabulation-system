      ...
      <div class="card-body">
        <table class="table table-bordered table-hover">
          <thead>
            ...
            <tr>
              <th class="text-center" title="Intelligence">Intelligence (40%)</th>
              <th
                class="text-center"
                title="Personal Outlook (Beauty of Face)"
              >Personal Outlook (40%)</th>
              <th class="text-center" title="Overall Performance">Overall Performance (20%)</th>
            </tr>
          </thead>
          <tbody>
            <tr
