             ...
             <div class="col-md-12">
                 <div class="card" :id="rating.id">
                     <div class="card-header clearfix">
                         <div class="card-title">#{{ rating.number }} - {{ rating.name }}
                            <button v-if="rating.is_final!=1" class="btn btn-warning float-sm-right" title="Modify" data-toggle="modal" :data-target="'#MyModal'+rating.id" aria-label="Left Align">
                                <span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>
                                EDIT
                            </button>
                            <button v-else class="btn btn-success float-sm-right" title="Final" aria-label="Left Align" data-toggle="modal" data-target="#msgBox01">
                     ...
                     <div class="card-body">
                         <div class="row">
                             ...
                             <div class="col-sm-8">
                                <ul class="list-group">
                                    <li v-for="ratingentry in ratingEntries" :key="ratingentry.id" class="list-group-item d-flex justify-content-between align-items-center">
                                        {{ ratingentry.criteria_name }}
                                        <span class="badge badge-primary badge-pill">{{ ratingentry.acquired_rating }}</span>
                                    </li>
                                    <li class="list-group-item d-flex justify-content-between align-items-center" style="background:#B3ECEC;">
                                        <b>Total</b>
...
<script>
    ...
    export default {
        ...
        methods:{
            ...
            {
                axios.get('/scoreboard/rating-entries/'+this.rating.id)
                    .then(response => {
