...
@section('content')
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12">
                <center style="font-weight:bold;font-size:18px;font-family: Arial, Helvetica, sans-serif;">Maranao Inspired Gown</center>
                <br />
            </div>
        </div>
        <div class="row">
            <br />
            <per-category-report vwname="vw_maranao"></per-category-report>
        </div>
        <div class="row">
            <div class="col-md-4">
                <br />
